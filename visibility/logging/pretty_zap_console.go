...
// It serializes the core log entry data (message, level, timestamp, etc.) in a plain-text
// format and leaves the structured context as a pretty-printed multiline JSON.
//
...
func (c *prettyConsoleEncoder) writeContext(line *buffer.Buffer, extra []zapcore.Field) {
    ...
    cleanuper := utils.NewCleanup0(func() {
...
func (c *prettyConsoleEncoder) tryGetStack(fieldsData map[string]interface{}) (string, bool) {
    ...
    var transmutedStack []StackElement

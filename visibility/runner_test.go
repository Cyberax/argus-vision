...
//	obs := NewObserver(ms, zap.NewNop())
//
//	err := RunInstrumented(ctx, obs, "test1",
...
//		_ = RunInstrumented(ctx, obs, "test1",
//			func(c context.Context) error {
//				panic("bad panic")
//			})
//	}, "bad panic")
...
//
//	ctx := ImbueContext(context.Background(), zap.NewNop())
//	obs := NewObserver(rs, zap.NewNop())
//
//	err := RunInstrumented(ctx, obs, "test1",
//		func(c context.Context) error {
//			met := GetMetricsFromContext(c)
//			met.AddCount("hellocount", 1)
//			met.AddMetric("gigametric", 12, cwtypes.StandardUnitGigabits)
//			return nil
//		})
